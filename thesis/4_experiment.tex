...
\begin{document}
    ...
    particularly when it comes to dense reconstruction. Table X presents the execution time of the sparse reconstruction
    ...
    This trick reduced the execution time significantly such that a dataset of 300 frames was reconstructed and
    refined in 6 minutes which means at the rate of 1 frame per second.
    ...
    One of the case studies if giving wider distorted images with manual calibration parameters to the SfM pipeline
    ...
    and Figure X illustrates the resulting sparse point cloud.
    The generated point cloud has notable error in the street angles, meaning that, from top point of view, the
    walls should be perpendicular to each other. However, Figure \ref{fig:ply_distorted} displays an angle that is less than 90 degrees,
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.45\textwidth}
            ...
            \caption{Point cloud generated from distorted frame from top viewpoint}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.45\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/experiment/ply_undistorted}
            \caption{Point cloud generated from undistorted frame from top viewpoint}
        \end{subfigure}
        \caption{Point clouds generated from distorted and undistorted video frames}
